              ...
              <v-row class="mt-n4 mb-n5 d-flex align-center">
                <v-col cols="12" md="8" order="2" order-md="1">
                  ...
                  <div>
                    ...
                    >
                      Currently there is no group draw yet. Please wait the
                      organizer draw the tournament after team registration
                      completed. Then all the fixtures of the group stage will be
                      displayed here.
                    </h1>
                  </div>
                </v-col>
