              ...
              <v-row class="mt-n4 mb-n5 d-flex align-center">
                <v-col cols="12" md="8" order="2" order-md="1">
                  ...
                  <div>
                    ...
                    >
                      Currently there is no tournament standings yet. Please
                      wait the organizer draw the tournament after team
                      registration completed. Then tournament standings of each
