              ...
              <v-row class="mt-n4 mb-n5 d-flex align-center">
                <v-col cols="12" md="8" order="2" order-md="1">
                  ...
                  <div>
                    ...
                    >
                      Currently final-stage participants list is empty. Kindly
                      wait the organizer to finalize qualified team in
                      <strong> Group Stage</strong>. Then, Final Stage fixtures
