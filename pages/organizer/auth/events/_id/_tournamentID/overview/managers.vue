    ...
    async onDeleteActive(mgr) {
      try {
        ...
        await this.$fire.firestore
          ...
          .doc(mgr.uid)
          .update({
            eventsMgr: firebase.firestore.FieldValue.arrayRemove({
              eventID: this.eventRef.eventID,
        ...
        await this.$fire.firestore
          ...
          .then((doc) => {
            ...
            const currentOrganizerInv = {
              category: currentOrganizerInvListFiltered.category,
              eventID: currentOrganizerInvListFiltered.eventID,
              eventName: currentOrganizerInvListFiltered.eventName,
              gender: currentOrganizerInvListFiltered.gender,
              organizerID: currentOrganizerInvListFiltered.organizerID,
              sportType: currentOrganizerInvListFiltered.sportType,
